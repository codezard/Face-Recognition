...
def faceDetection(test_img):             
    ...
    face_haar=cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml") #Give path to haar classifier as i have given
...
def put_text(test_img,text,x,y):                                    
    cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),2)
